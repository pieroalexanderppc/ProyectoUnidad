...
<body>
     ...
     <div class="container mt-5" id="top">
        ...
        <%
    ClsModeloAdministrador adminAutenticadopes = (ClsModeloAdministrador) session.getAttribute("adminAutenticado");
%>


<% if (adminAutenticadopes != null && !adminAutenticadopes.getRol().equalsIgnoreCase("Lectura") && !adminAutenticadopes.getRol().equalsIgnoreCase("Administrador")) { %>
<% } %>
...
<% if (adminAutenticadopes != null && !adminAutenticadopes.getRol().equalsIgnoreCase("Lectura")) { %>
