  ...
  <body class="dark">
    <section class="sidebar">
      ...
      <ul class="side-menu top">
        ...
        <!--la parte de gabriellllll, dios funciona-->
...
<% if (adminAutenticadope != null && !adminAutenticadope.getRol().equalsIgnoreCase("Lectura") && !adminAutenticadope.getRol().equalsIgnoreCase("Administrador")) { %>
    <li>
          <a href="/idiomify/ConsultaServlet?accion=listarAuditoria" class="my-nav-link">
   ...
   <!--NO URGES ESTE CARD PORQUE ESTO LO HAGO JAVAS SCRIPT SOLO LO ATERIROR-->
        <div class="profile-card" id="profile-card">
          <div class="card-content">
            <img src="/idiomify/admin/${adminAutenticadope.fotoPerfil}" alt="Foto de Perfil" />
            <p>${adminAutenticadope.nombre} ${adminAutenticadope.apellido}</p>
