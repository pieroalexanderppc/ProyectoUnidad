...
<body>
    ...
    <div class="card">
        <h1>Usuarios por Mes</h1>

        <%
            ClsModeloDaoConsultas consultasDao = new ClsModeloDaoConsultas();
            Map<String, Integer> usuariosPorMes = consultasDao.obtenerUsuariosPorMes();
            ...
            Set<Map.Entry<String, Integer>> entrySet = usuariosPorMes.entrySet();
        ...
        <script>
            ...
            // Parsear los datos de Java a JavaScript.
            var meses = <%= meses %>;
