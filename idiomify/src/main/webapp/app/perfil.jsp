...
<c:if test="${usuarioAutenticado != null}">
    <div class="profile-card">
        <div class="profile-image">
            <img src="${usuarioAutenticado.fotoPerfil}" alt="Foto de Perfil">
        </div>
        <div class="profile-details">
            ...
            <div class="profile-field">
                ...
                <div class="profile-value">Nombre: ${usuarioAutenticado.nombre}</div>
            </div>
            <!-- ... (otros campos) ... -->
            <div class="profile-field">
                <div class="profile-icon"><i class="fas fa-envelope"></i></div>
                <div class="profile-value">Email: ${usuarioAutenticado.email}</div>
            </div>
            <!-- Puedes agregar m?s campos seg?n tus necesidades -->
            
            <a href="editarperfil.jsp" class="edit-button">Editar Perfil</a><br>
            ...
            List<ClsModeloHistorialUsuario> historiales = historialDAO.listarHistorial(idUsuario);
                   for (ClsModeloHistorialUsuario historial : historiales) { %>
                   <tr>
                        
                       <td><%= historial.getIdHistorial() %></td>
                       <td><%= historial.getFKidiLeccion() %></td>

                       <td>
                           <div class="acciones-icons">
                               <!-- Puedes cambiar las URLs de los enlaces seg?n tus necesidades -->
                               <a href="/idiomify/AdministradorServlet?accion=editarAdmin&dniAdmin=<%= historial.getFKidiLeccion()%>" class="btn btn-warning">
                                   <i class="bi bi-pencil"></i>RETORMAR LECCION
                               </a>
                           </div>
                       </td>
                   </tr>
